...
if importlib.util.find_spec("pytest") is not None:
    ...
    def test_merge_characters_and_duplicate():
        ...
        assert (
            operations.merge_characters_and_duplicate("Skryptowe")
            == "SwSwSwSwSwSwSwSwSw"
        )
        assert operations.merge_characters_and_duplicate("SP") == "SSSS"
        assert operations.merge_characters_and_duplicate("S") == "S"
    ...
    class Test_TestTextOperations(unittest.TestCase):
        ...
        def test_merge_characters_and_duplicate(self):
            ...
            self.assertEqual(operations.merge_characters_and_duplicate("SP") == "SSSS")
            self.assertEqual(operations.merge_characters_and_duplicate("S") == "S")
